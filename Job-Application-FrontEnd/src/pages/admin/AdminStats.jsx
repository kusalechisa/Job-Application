...
export default function AdminStats() {
  ...
  const calculateAveragePerJob = () => {
    if (!stats?.applicationsByJob || stats.applicationsByJob.length === 0)
      return 0;
    const total = stats.applicationsByJob.reduce(
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Comprehensive overview of application statistics and
                  performance metrics
                </p>
              </div>
                          ...
                          <div key={status} className="space-y-2">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                                  className={`${getStatusColor(status)} gap-1`}
                                >
                            ...
                            <div className="h-2 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                              <div
                                ...
                                style={{
                                  ...
                                  backgroundColor:
                                    COLORS[
                                      Object.keys(stats.statusCounts).indexOf(
                                        status,
                                      ) % COLORS.length
                                    ],
                                }}
