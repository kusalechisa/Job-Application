        ...
        <main className="p-4 md:p-6 lg:p-8">
          ...
          <div className="mb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="rounded-2xl bg-white dark:bg-slate-900 p-6 shadow-lg border border-slate-200 dark:border-slate-700">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">Featured Jobs</p>
            </div>
          </div>
            ...
            <CardContent className="p-0">
              {loading ? (
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-slate-50 dark:bg-slate-800/50">
                        ...
                        <TableHead className="font-semibold hidden lg:table-cell">Posted</TableHead>
                          ...
                          <TableRow key={job.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all">
                            ...
                            <TableCell>
                              <div className="flex flex-wrap gap-1">
                                <Button size="sm" variant="ghost" onClick={() => openEdit(job)} title="Edit" className="h-8 w-8 p-0">
                                  <Pencil className="h-4 w-4" />
                                </Button>
                                <Button size="sm" variant="ghost" onClick={() => handleDuplicate(job)} title="Duplicate" className="h-8 w-8 p-0">
                                ...
                                <Button 
                                  ...
                                  title={job.status === "active" ? "Unpublish" : "Publish"}
                                  className="h-8 w-8 p-0"
                                >
                                  {job.status === "active" ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                                </Button>
                                <Button size="sm" variant="ghost" onClick={() => handleDelete(job.id)} title="Delete" className="h-8 w-8 p-0">
                                  <Trash2 className="h-4 w-4 text-red-600" />
                                </Button>
                                <Button size="sm" variant="ghost" onClick={() => handleDownload(job.id, job.title)} title="Download Applications" className="h-8 w-8 p-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
                  {jobs.map((job) => (
                    <div key={job.id} className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 hover:shadow-lg transition-all">
                      ...
                      <div className="flex flex-wrap gap-2 pt-3 border-t border-slate-200 dark:border-slate-700">
                        <Button size="sm" variant="outline" onClick={() => openEdit(job)} className="flex-1">
                          <Pencil className="h-3 w-3 mr-1" /> Edit
                        </Button>
                        <Button size="sm" variant="outline" onClick={() => handleDownload(job.id, job.title)} className="flex-1">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="featured" className="cursor-pointer">
                          Feature this job (will appear prominently on the careers page)
                        </Label>
                      </div>
                    </div>
